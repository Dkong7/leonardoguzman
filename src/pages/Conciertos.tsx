...
const Conciertos = () => {
  ...
  const widgetContainerStyle = isDark 
    ? 'bg-[#120b18]/80 backdrop-blur-xl border border-white/10 shadow-[0_0_50px_rgba(147,51,234,0.15)]' 
  ...
  return (
    <div className={`min-h-screen relative font-sans pb-32 transition-colors duration-500 overflow-hidden ${isDark ? 'bg-[#050505]' : 'bg-[#e0e5ec]'}`}>
      ...
      <div className="relative pt-36 pb-12 text-center z-10 px-4">
          <h1 className={`text-6xl md:text-8xl font-serif font-black tracking-tighter uppercase mb-6 ${textPrimary} drop-shadow-2xl`}>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
          ...
          {/* TARJETA DEL WIDGET (LIMPIA) */}
          <div className={`rounded-[3rem] overflow-hidden p-8 md:p-12 transition-all duration-500 ${widgetContainerStyle}`}>
