...
import { 
    faVideo, faHeart, faCheckCircle, faBookOpen, faExclamationCircle, faUser, 
    faClock, faEnvelope, faVideoCamera, faDownload, faGraduationCap, faStore, faPlayCircle, faArrowLeft
} from '@fortawesome/free-solid-svg-icons';
import { faMicrosoft, faGoogle, faWhatsapp, faInstagram, faFacebook } from '@fortawesome/free-brands-svg-icons';
    ...
    <div className="min-h-screen bg-[#fcfbff] text-gray-700 font-sans selection:bg-purple-200 relative overflow-x-hidden">
      ...
      <nav className="absolute top-0 left-0 w-full px-6 py-8 flex justify-between items-center z-50 max-w-7xl mx-auto right-0">
          ...
          <div className="flex items-center gap-4 md:gap-8">
             ...
             <Link to="/login" className="group flex items-center gap-3 px-6 py-2.5 bg-[#1a0b2e] border border-purple-900/50 rounded-full shadow-xl shadow-purple-900/20 hover:bg-[#2d1b4e] transition-all">
                ...
                <span className="text-[10px] font-black text-purple-100 uppercase tracking-[0.15em]">{t('school')} Virtual</span>
                <FontAwesomeIcon icon={faUser} className="text-purple-400 group-hover:text-white transition-colors" />
             </Link>
          </div>
      </nav>

      {/* --- HERO DOJO (INTEGRACIÓN GUITARROSIS) --- */}
      <header className="relative pt-60 pb-32 px-6 z-10">
        <div className="max-w-4xl mx-auto text-center">
            ...
            <motion.div 
              ...
              className="mb-10"
            >
                <img src="/guitarrosis-logo.svg" alt="Guitarrosis" className="h-24 md:h-32 mx-auto drop-shadow-[0_10px_20px_rgba(168,85,247,0.2)]" />
            </motion.div>
            ...
            <h1 className="text-5xl md:text-7xl font-serif text-[#1a0b2e] mb-8 tracking-tight leading-[1.1]">
                {t('dojo_title').split(' ')[0]} {t('dojo_title').split(' ')[1]} <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500 relative">
                    {t('dojo_title').split(' ')[3]}
            ...
            <p className="text-xl md:text-2xl text-gray-500 font-light mb-12 leading-relaxed max-w-2xl mx-auto">
                {t('dojo_subtitle')}
            </p>
            
            <div className="flex justify-center gap-4">
                <Link to="/clases/material" className="px-8 py-4 bg-white text-purple-900 border border-purple-100 rounded-xl font-black text-xs uppercase tracking-widest shadow-lg hover:shadow-xl transition-all flex items-center gap-3">
      ...
      <section className="py-24 px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
            <div className="bg-white rounded-[3rem] p-8 md:p-16 shadow-[0_20px_50px_-12px_rgba(100,50,150,0.1)] border border-purple-50 grid grid-cols-1 md:grid-cols-2 gap-16 items-center overflow-hidden relative">
                <div className="absolute top-0 right-0 w-64 h-64 bg-purple-100/50 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2"></div>

                <div>
                    <div className="w-16 h-16 bg-purple-50 rounded-2xl flex items-center justify-center text-purple-600 mb-8 text-3xl shadow-inner">
                        <FontAwesomeIcon icon={faVideo} />
                    </div>
                    <h3 className="text-3xl md:text-4xl font-serif text-gray-800 mb-6">{t('digital_dojo')}</h3>
                    <p className="text-gray-600 mb-8 leading-relaxed text-lg">{t('dojo_desc')}</p>
                    <div className="flex gap-4">
                        <div className="flex items-center gap-3 px-5 py-3 rounded-xl border border-gray-100 bg-gray-50/50">
                            <FontAwesomeIcon icon={faMicrosoft} className="text-2xl text-[#464EB8]" />
                            <span className="font-bold text-gray-700 text-sm">Teams</span>
                        </div>
                        <div className="flex items-center gap-3 px-5 py-3 rounded-xl border border-gray-100 bg-gray-50/50">
                            <FontAwesomeIcon icon={faGoogle} className="text-2xl text-[#EA4335]" />
                            <span className="font-bold text-gray-700 text-sm">Meet</span>
                        </div>
                    </div>
                </div>

                <div className="space-y-6">
                    <div className="bg-[#f8f7fc] p-6 rounded-2xl border border-purple-100/50 hover:bg-purple-50 transition-colors group">
                        <div className="flex items-start gap-4">
                            <div className="p-3 bg-white rounded-lg text-purple-500 shadow-sm group-hover:scale-110 transition-transform">
                                <FontAwesomeIcon icon={faVideoCamera} />
                            </div>
                            <div>
                                <h4 className="font-bold text-gray-800 mb-1">{t('record_progress')}</h4>
                                <p className="text-sm text-gray-500">{t('record_desc')}</p>
                            </div>
                        </div>
                    </div>
                    <div className="bg-[#f8f7fc] p-6 rounded-2xl border border-purple-100/50 hover:bg-purple-50 transition-colors group">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-800 mb-1">{t('effective_time')}</h4>
                                <p className="text-sm text-gray-500">{t('time_desc')}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
                ...
                <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-xl hover:shadow-2xl transition-all relative overflow-hidden group">
                    ...
                    <div className="mb-8 border-b border-gray-50 pb-8">
                        <div className="flex items-baseline gap-1">
                            <span className="text-4xl font-bold text-gray-900 tracking-tight">$320k</span>
                ...
                <div className="bg-[#2d1b4e] text-white p-10 rounded-[2.5rem] shadow-2xl shadow-purple-900/40 transform md:scale-110 relative z-10 border border-purple-500/30">
                    ...
                    <div className="mb-8 border-b border-white/10 pb-8 relative z-10">
                        <div className="flex items-baseline gap-2">
                            <span className="text-5xl font-bold text-white tracking-tight">$250k</span>
                ...
                <div className="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-xl hover:shadow-2xl transition-all relative overflow-hidden group">
                    ...
                    <div className="mb-8 border-b border-gray-50 pb-8">
                        <div className="flex items-baseline gap-1">
                            <span className="text-4xl font-bold text-gray-900 tracking-tight">$460k</span>
                            <span className="text-xs text-gray-400 font-bold">COP</span>
                        </div>
                        <div className="flex items-baseline gap-1 mt-1 text-gray-500">
      ...
      <section className="py-24 bg-white relative z-10">
        <div className="max-w-5xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                <div>
                    <h2 className="text-3xl font-serif text-gray-800 mb-10">{t('protocol_title')}</h2>
                    <div className="space-y-10">
                        <div className="flex gap-6 group">
                            <span className="text-5xl font-serif text-purple-100 group-hover:text-purple-200 transition-colors">01</span>
                            <div>
                                <h4 className="font-bold text-gray-800 mb-2 text-lg">{t('check_tech')}</h4>
                                <p className="text-gray-500 leading-relaxed text-sm">{t('check_desc')}</p>
                            </div>
                        </div>
                        <div className="flex gap-6 group">
                            <span className="text-5xl font-serif text-purple-100 group-hover:text-purple-200 transition-colors">02</span>
                            <div>
                                <h4 className="font-bold text-gray-800 mb-2 text-lg">{t('comm_title')}</h4>
                                <p className="text-gray-500 leading-relaxed text-sm">{t('comm_desc')}</p>
                            </div>
                        </div>
                        <div className="flex gap-6 group">
                            <span className="text-5xl font-serif text-purple-100 group-hover:text-purple-200 transition-colors">03</span>
                            <div>
                                <h4 className="font-bold text-gray-800 mb-2 text-lg">{t('homework_title')}</h4>
                                <p className="text-gray-500 leading-relaxed text-sm">{t('homework_desc')}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative">
                    <div className="absolute inset-0 bg-purple-600 rounded-[3rem] rotate-3 opacity-10"></div>
                    <div className="bg-white p-10 rounded-[3rem] border border-purple-100 shadow-2xl relative h-full">
                        <div className="w-12 h-12 bg-red-50 rounded-full flex items-center justify-center text-red-400 mb-6 text-xl">
                            <FontAwesomeIcon icon={faExclamationCircle} />
                        </div>
                        <h3 className="font-serif text-2xl text-purple-900 mb-4">{t('policy_title')}</h3>
                        <p className="text-sm text-gray-500 mb-8 italic border-l-2 border-purple-200 pl-4">{t('policy_quote')}</p>
                        <ul className="space-y-5 text-sm text-gray-600">
                            <li className="flex gap-4 items-start"><span className="bg-purple-100 text-purple-700 font-bold rounded px-2 py-0.5 text-xs mt-0.5">1</span><span>{t('policy_1')}</span></li>
                            <li className="flex gap-4 items-start"><span className="bg-purple-100 text-purple-700 font-bold rounded px-2 py-0.5 text-xs mt-0.5">2</span><span>{t('policy_2')}</span></li>
                            <li className="flex gap-4 items-start"><span className="bg-purple-100 text-purple-700 font-bold rounded px-2 py-0.5 text-xs mt-0.5">3</span><span>{t('policy_3')}</span></li>
                            <li className="flex gap-4 items-start p-3 bg-purple-50 rounded-xl">
                                <FontAwesomeIcon icon={faPlayCircle} className="text-purple-600 mt-1" />
                                <span className="text-purple-900 font-medium">{t('policy_plan_b')}</span>
                            </li>
                        </ul>
                    </div>
                </div>
      ...
      {/* --- FOOTER FINAL --- */}
      <footer className="bg-[#1a0b2e] text-white py-32 text-center px-6 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto relative z-10">
            ...
            <p className="text-purple-200/60 mb-12 leading-relaxed font-light text-xl">{t('footer_dojo_desc')}</p>
