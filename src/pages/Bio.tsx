...
import { faGuitar, faTrophy, faGlobe, faUsers, faBolt } from '@fortawesome/free-solid-svg-icons';
       ...
       <div className='max-w-6xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-12 relative'>
             ...
             <div className='pl-12 border-l border-nardo-800 md:border-none relative pb-12'>
                ...
                <p className='text-gray-400 text-sm'>Creación de una de las primeras comunidades online de guitarra en LATAM. +20,000 miembros.</p>
             </div>
             ...
             <div className='pl-12 border-l border-nardo-800 md:border-none relative pb-12'>
                ...
                <p className='text-gray-400 text-sm'>NAMM Show (USA), Masterclasses en Japón, Ecuador y Colombia. Endorser de Cort, Strandberg y GruvGear.</p>
             </div>
          </div>
          ...
          <div className='text-center mt-20 p-8 bg-nardo-900 rounded-xl border border-nardo-800'>
             ...
             <p className='max-w-2xl mx-auto text-gray-400'>"Una fusión perfecta entre la precisión técnica del virtuosismo moderno y el alma del folclor latinoamericano."</p>
          </div>
       </div>
    </div>
  );
